#ifndef _LIBUSBD_PLAT_LINUX_IMPL_H
#define _LIBUSBD_PLAT_LINUX_IMPL_H
...
#define LIBUSBD_LINUX_ERR_NOTACTIVATED (0xE0000001)
#define LIBUSBD_LINUX_ERR_TIMEOUT (0xE00002D6)
#define LIBUSBD_LINUX_FAKERET_BADARGS (0xFF0002C2)

#endif // _LIBUSBD_PLAT_LINUX_IMPL_H
