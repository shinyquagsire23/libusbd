...
async fn usb_print_task(rx: Receiver<SentKeypress>, rx_mouse: Receiver<SentMouse>)
{
    ...
    /*let resp_0: [u8; 64] = [0x81, 0x01, 0x00, 0x03, 0x7D, 0x03, 0xBF, 0xE5, 0xD2, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                ...
                match subcmd {
                    ...
                    0x10 => {
                        ...
                        if addr == 0x6000 && len == 16 {
                            let dat_6000: [u8; 16] = [0x00, 0x00, 0x58, 0x53, 0x4c, 0x34, 0x30, 0x30, 0x30, 0x30, 0x39, 0x30, 0x31, 0x35, 0x37, 0x30];
                            for i in 0..16 {
